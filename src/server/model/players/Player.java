...
public abstract class Player {
	...
	public boolean inMulti() {
		if((absX >= 3136 && absX <= 3327 && absY >= 3519 && absY <= 3607) || 
			...
			(absX >= 2780 && absX <= 2960 && absY >= 9683 && absY <= 9883) ||
			(absX >= 3386 && absX <= 3586 && absY >= 9828 && absY <= 10028) ||
			(absX >= 2752 && absX <= 2952 && absY >= 3655 && absY <= 3855) ||
			(absX >= 3157 && absX <= 3191 && absY >= 2965 && absY <= 2995) ||
			(absX >= 3461 && absX <= 3510 && absY >= 9481 && absY <= 9520) ||
			(absX >= 2496 && absX <= 2539 && absY >= 4629 && absY <= 4665) ||
			(absX >= 2841 && absX <= 2885 && absY >= 3577 && absY <= 3602) ||
			(absX >= 3093 && absX <= 3127 && absY >= 3577 && absY <= 3708) ||
			(absX >= 2768 && absX <= 2968 && absY >= 9837 && absY <= 10037)) {
			return true;
		}
		return false;
	}
	...
	public boolean inDonatorzone() {
		if ((absX >= 2470 && absX <= 2570 && absY >= 4730 && absY <= 4830)) {
		return false;
		}
		return true;
	}
	public boolean inGhostspot() {
		if ((absX >= 2706 && absX <= 2716 && absY >= 9557 && absY <= 9570)) {
		return false;
		}
		return true;
	}
	public boolean inStaffzone() {
		if ((absX >= 2884 && absX <= 2901 && absY >= 3505 && absY <= 3516)) {
		return false;
		}
		return true;
	}
	public boolean inWildsong() {
		if ((absX >= 3163 && absX <= 3655 && absY >= 3798 && absY <= 4462)) {
		return false;
		}
		return true;
	}
	...
	public Player(int _playerId) {
		...
		playerAppearance[10] = 6; // legs colour
