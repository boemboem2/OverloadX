...
public class Farming {
	...
	private final int[] SEED_PLANT_EXP = {11,14,16,22,27,34,43,55,69,88,107,135,145,170};
	private final int[] HERB_EXPS = {13,15,18,24,31,39,49,62,78,99,120,152,172,205};
	...
	public void updateHerbPatch() {
		if (c.farm[0] > 0 && c.farm[1] > 0) {
			//make object here
			c.sendMessage("The seed grows into a herb plant.");
			c.getPA().object(PATCH_HERBS,2239,3196,-1,10);
		} else {
			//make weed patch here
			c.sendMessage("You pick all of the herbs and weeds grow in.");
			c.getPA().object(PATCH_WEEDS,2239,3196,-1,10);
		}	
	}
